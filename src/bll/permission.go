...
// BatchAdd 批量添加权限
func (b *Permission) BatchAdd(ctx context.Context, tenant *schema.Tenant, permissions []string) (
...
// Delete 删除权限
func (b *Permission) Delete(ctx context.Context, tenant *schema.Tenant, permission string) (
	*tpl.SuccessResponseType, error) {
...
func (b *Permission) List(ctx context.Context, tenant *schema.Tenant, resources []string, pg *tpl.Pagination) (
	*tpl.SuccessResponseType, error) {
